# FROZEN 2026-08-24 — pre-registration appendum, T0 Gram correction

Frozen from `SERVER_GRAM_CORRECTION_DIRECTIVE_20260824.md` before any run it
prescribes. Nothing here retroactively validates any previously reported number.
Registered parameters: tau = 1e-3 * lambda_max(G_l), alpha = 0.05, feature-norm
bound = empirical max on Stage-B' with a 1.5x margin, H-G1 threshold 0.02.
