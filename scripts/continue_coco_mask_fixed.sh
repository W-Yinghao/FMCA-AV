...
sleep 300
run_id="$(submit_with_capacity_wait --name coco2017-fmca-maskrcnn-16step-smoke-fixed --gpus 1 --profile imagenet -- \
  ...
  --task instance_segmentation --max-steps 16 --train-images 1000 --val-images 100)"
