...
Snapshot: 2026-08-09 04:39 CEST. The experiment program is running and is not yet complete.
...
- E10: the first preserved child `930585` exposed the nonfinite guard. Retry `20260809-040629_postfix-e10-complexity` completed 16/20 conditions but showed that all four 224-pixel FP16 backbone conditions overflowed while constructing moments. Slurm CPU job `930995` verifies FP32 accumulation for FP16/BF16 features, finite gradients, and renderer policy rejection. Watcher `20260809-041821_postfix-e10-benchmark-chain-fp32moments` preserves that run as superseded; corrected complexity `20260809-043326_postfix-e10-complexity` completed and the chain advanced through operator and FLOPs profiling before rendering.
